/**
 * Created by Bombassd on 10.06.2017.
 */
// ==UserScript==
// @version       1.2.0
// @name          C&C:TA CnC-Eco Link Button
// @namespace     http://cnc-eco.de/
// @icon          http://www.cnc-eco.de/favicon.ico
// @description   Creates a "CnC-Eco" button when selecting a base in Command & Conquer: Tiberium Alliances. The share button takes you to http://cnc-eco.de/ and fills in the selected base information so you can analyze or share the base.
// @include       http*://*.alliances.commandandconquer.com/*/index.aspx*
// @include       http*://*.cnc-eco.de/*
// @include       http*://www.cnc-eco.de/*
// @grant         GM_log
// @grant         GM_setValue
// @grant         GM_getValue
            ...
            function cnceco_create() {
                ...
                var cnceco = {
                    ...
                    make_sharelink: function () {
                        try {
                            ...
                            var link = "http://www.cnc-eco.de/b/";
                            link += "3|"; /* link version */
                ...
                webfrontend.gui.region.RegionCityMenu.prototype.showMenu = function (selected_base) {
                    try {
                        ...
                        cnceco.selected_base = selected_base;
                        if (this.__cnceco_initialized != 1) {
                            this.__cnceco_initialized = 1;
                            this.__cnceco_links = [];
                            for (var i in this) {
                                try {
                                    if (this[i] && this[i].basename == "Composite") {
                                        var link = new qx.ui.form.Button("CnC-Eco", "http://www.cnc-eco.de/favicon.ico");
                        ...
                        function check_if_button_should_be_enabled() {
                            try {
                                ...
                                if (tf != button_enabled) {
                                    button_enabled = tf;
                                    for (var i = 0; i < self.__cnceco_links.length; ++i) {
                                        self.__cnceco_links[i].setEnabled(tf);
                                    }
                                }
                                if (!still_loading) {
                                    check_ct = 0;
