    ...
    render() {
        ...
        return (
            ...
            <header className="main-header">
                <ul className="menu">
                    <li className="menu__item" data-sub="product"><a href="#">Product</a></li>
                    <li className="menu__item" data-sub="developer"><a href="#">Developer</a></li>
                    <li className="menu__item" data-sub="company"><a href="#">Company</a></li>
                </ul>
                                ...
                                <div className="top-section">
                                    <div className="col-2">
                                        <ul>
                                            ...
                                            <li><a href="">
                                                <h3>Connect</h3>
                                                <p> consectetur adipisicing elit nesciunt! Assumenda, adipisci.</p></a>
                                            </li>
                                            <li><a href="">
                                                <h3>Atlas</h3>
