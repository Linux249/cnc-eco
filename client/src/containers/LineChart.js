...
class LineChart extends Component {
    ...
    makePath() {
        ...
        return (
            <Path d={pathD} style={{stroke: color}} />
        );
    }
    // BUILD SHADED AREA
    makeArea() {
    ...
    makeLabels(){
        ...
        return(
            <Label>
                ...
                <text transform={`translate(${yLabelSize/2 + 20}, ${svgHeight - xLabelSize - padding})`} textAnchor="middle">
        ...
        return (
            <g>
                <Line
                    ...
                    x1={this.state.lineLeft} y1={-8}
                    x2={this.state.lineLeft} y2={svgHeight - xLabelSize} />
                <Line
                    onMouseDown={() => this.startDrag("right")}
                    x1={this.state.lineRight} y1={-8}
                    x2={this.state.lineRight} y2={svgHeight - xLabelSize} />
            </g>
    ...
    makeRect() {
        ...
        return (
            <Rect x={lineLeft} y="0" width={width} height="278"/>
