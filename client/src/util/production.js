...
export const calcBuildingProduction = (buildings, i) => {
    ...
    const harvest_production_packet = [
        0,
        40,
        300,
        432,
    ...
    if (building) {
        ...
        if (building.type === 's') {
            neighbours.forEach((
                n // schaut nach angeschlossenen sammlern
            ) => {
        ...
        // get power from PowerPlants
            ...
            neighbours.forEach(n => {
                ...
                if (0 <= j && j <= 71) {
                    ...
                    if (buildings[j] && (buildings[j].type === 'n' || buildings[j].type === 'c')) {
                        // p = PowerPlant
